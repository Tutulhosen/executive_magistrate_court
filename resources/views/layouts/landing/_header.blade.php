                    ...
                    <div class="btn  -mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                        ...
                        <span class="text-muted font-size-base d-none d-md-inline mr-1">
                            @if(globalUserInfo()->profile_pic != NULL)
                                <img src="{{url('/')}}/uploads/profile/{{ globalUserInfo()->profile_pic }}">
                            @else
                        ...
                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-info bg-primary p-2 text-light rounded">
                            <span class="">{{ roleName(globalUserInfo()->role_id)->role_name }}</span>
                        </span>
                    </div>
                </div>
            <!--end::User-->
        ...
        <div class="topbar_wrapper">
            <div class="topbar pt-3">
                    ...
                    <div class="tpbar_text_menu tpbar_text_mlast topbar-item topbarmenu_item mr-8">
                        <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                            id="kt_quick_user_toggle">
                            <a href="{{ route('cprc.home.page') }}" class="svg-icon svg-icon-primary svg-icon-2x">আইন ও বিধি</a>
                        </div>
                    </div>
                    <div class="topbar-item topbarmenu_item">
                        <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                            id="topbar_social_icon">
                            <a href="https://www.facebook.com/Ecourtbd"  target="_blank" class="social-svg-icon svg-icon-primary svg-icon-2x">
