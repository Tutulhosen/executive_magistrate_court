<div class="card card-custom mb-5 shadow">
    <div class="card-header bg-primary-o-50">
        <div class="card-title">
            ...
            <h3 class="card-label">তদন্তের রিপোর্ট গ্রহনের জন্য অপেক্ষমাণ
        </div>
    </div>
    <div class="card-body">
        {{-- @php 
        ...
        <table class="table table-hover table-bordered report">
            ...
            <tbody>
                @foreach ($em_investigation_report_before_accepted as $value)
                    <tr class="investigation_delete_{{ $value->id }}">
                        @php
                            $investigation_date = explode('/', $value->investigation_date);
                            $investigation_date_final =
                                $investigation_date[2] . '-' . $investigation_date[0] . '-' . $investigation_date[1];
                        @endphp
                            ...
                            <div class="btn-group float-right">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('investigation.details.single', ['id' => $value->id]) }}">বিস্তারিত</a>
                                    @if (in_array(globalUserInfo()->role_id, [27, 7, 38, 37]))
                                        {{-- <a class="dropdown-item" href="javascript:void(0)"
                                            id="investigation_delete_{{ $value->id }}" 
                                            onclick="investigation_delete(this.id)" >মুছে ফেলুন</a> --}}
                                        <a class="dropdown-item " href="javascript:void(0)"
                                            id="investigation_approve_{{ $value->id }}"
                                            onclick="investigation_approve(this.id)">গ্রহন করুন</a>
                                    @endif
