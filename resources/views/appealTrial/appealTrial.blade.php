            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <div class="card-body">
                                                    ...
                                                    <div id="collapseOne3{{ $count }}"
                                                        ...
                                                        <div class="card-body border-secondary">
                                                            <div class="clearfix ">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <h4 class="text-right">পেশকার কর্তৃক গৃহীত ব্যবস্থা ,
                                                                            {{ en2bn($item['order_date_peskar'] ?? '') }}
                                                                        </h4>
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div
                                                                      ...
                                                                      @php
                                                                        ...
                                                                        <div class="col-md-12 mt-3">
                                                                            <h4 class="p-4">{{ $em_text }} আদেশ
                                                                                ,
                                                                                {{ en2bn($item['order_date'] ?? '') }}
                                                                            </h4>
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div
                    ...
                    <div class="card card-custom mb-5 shadow">
                        <div class="card-header bg-primary-o-50">
                            <div class="card-title">
                                ...
                                <h3 class="card-label">Voice to Text
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="panel panel-info radius-none ">
                    ...
                    <form id="appealCase" action="" class="form" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="law_sec_id" value="{{ $crpcID }}">
                        ...
                        <div class="card card-custom mb-5 shadow">
                            ...
                            <div class="card-body">
                                <div class="panel panel-info">
                                       @include('appealInitiate.inc.peskar_initial_comments')
                                    <div class="panel-body">
                                        <div hidden="hidden" id="paymentInformation" class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group"><label for="dueAmount"
                                                    ...
                                                    <div id="dueAmount" class="text-primary">0 টাকা</div> <input
                                                        type="hidden" value="" id="dueAmountValue">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                               <div class="form-group">
                                                <label for="form-label">খুঁজুন (আদেশের ধরণ)</label>
                                        ...
                                        <div class="row" id="appeal_date_time_status_new">
                                            <div class="col-md-4">
                                                <div class="form-group"><label>আদেশের ধরণ</label>
                                                    ...
                                                    <div class="form-control form-control-md"
                                                        style="height: 253px; overflow-y: scroll;">
                                                            ...
                                                            <label class="radio radio-outline radio-primary mb-3  '' }}">
                                                                ...
                                                                <span class="mr-2 case_short_decision_data" data-row_id_index=""></span>
                                                                test order 1
                                                            </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group" id="investigatorDetails" style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">

                                                                <h3 class="card-label">তদন্তকারীর তথ্য
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            @include('appealTrial.inc._investigatorDetails')
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" id="warrantExecutorDetails"
                                                    style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group" id="warrantExecutorZellSuperDetails"
                                                    style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">
                                                                <h3 class="card-label">জেল সুপার তথ্য </h3>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            @include('appealTrial.inc._warrentExecutorDetailsZillSuper')
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" id="law_enforcement_forces_Details"
                                                    style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">
                                                                <h3 class="card-label">আইনশৃঙ্খলা বাহিনী তথ্য </h3>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            @include('appealTrial.inc._law_enforcement_forces')
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" id="receiver_land_details"
                                                    style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">
                                                                <h3 class="card-label">রিসিভার তথ্য </h3>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            @include('appealTrial.inc._receiver_land')
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group" id="bond_amount_bond_details"
                                                    style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">
                                                                <h3 class="card-label">বন্ডের তথ্য</h3>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            @include('appealTrial.inc._bond_money_period')
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group" id="complain_details"
                                                    style="display: none;">
                                                    <div class="card card-custom mb-5 shadow">
                                                        <div class="card-header bg-primary-o-50">
                                                            <div class="card-title">
                                                                <h3 class="card-label">অভিযোগের সংক্ষিপ্ত বিবরণ </h3>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            @include('appealTrial.inc._complain')
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group"><label for="applicantDesignation"
                                                            ...
                                                            class="form-control form-control-md">{{ isset($applicantCitizen[0]->email) ? $applicantCitizen[0]->email : '-' }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="radio">
                                                            <label>
                                                                <input onchange="AttPrintHideShow('1')"
                                                                    id="applicantAttendancePresent" type="radio"
                                                                    name="citizenAttendance[1][attendance]"
                                                                    value="PRESENT" checked="checked" class="">
                                                                উপস্থিত
                                                            </label>
                                                            <label class="ml-2">
                                                                <input onchange="AttPrintHideShow('1')"
                                                                    id="applicantAttendanceAbsent" type="radio"
                                                    ...
                                                    <div class="form-group" id="attVic1">
                                                        ...
                                                        <div>
                                                            <a href="javascript:void(0)"
                                                                ...
                                                                class="btn btn-info">হাজিরা প্রিন্ট </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="defaulterName" class="control-label">
                                                            <span style="color: rgb(255, 0, 0);"></span>২য় পক্ষের নাম
                                                        </label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group"><label for="defaulterDesignation"
                                                            ...
                                                            class="form-control form-control-md">{{ isset($defaulterCitizen[0]->email) ? $defaulterCitizen[0]->email : '-' }}</span>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group"><label for="defaulterAttendance"
                                                            class="control-label"><span style="color: rgb(255, 0, 0);">*
                                                            </span>
                                                            হাজিরা</label>
                                                        <div class="radio">
                                                            <label>
                                                                <input onchange="AttPrintHideShow('2')"
                                                                    id="defaulterAttendancePresent" type="radio"
                                                                    name="citizenAttendance[2][attendance]"
                                                                    value="PRESENT" checked="checked"
                                                                    class="defaulterAttendance">
                                                                উপস্থিত
                                                            </label>
                                                            <label class="ml-2">
                                                                <input onchange="AttPrintHideShow('2')"
                                        ...
                                        @else
                                            ...
                                            <div class="row" hidden="hidden">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="defaulterName" class="control-label">
                                                            <span style="color: rgb(255, 0, 0);"></span>বিবাদীর নাম
                                                        </label>
                                                        <span id="defaulterName"
                                                            class="form-control form-control-md">{{ $defaulterCitizen[0]->citizen_name ?? '' }}</span>
                                                        <input type="hidden" name="citizenAttendance[2][id]"
                                            ...
                                            <div class="row" id="appeal_date_time_status">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        @if (globalUserInfo()->role_id != 37 && globalUserInfo()->role_id != 38 && globalUserInfo()->role_id != 7)
                                                        ...
                                                        @if(!in_array($appeal->appeal_status,["ON_TRIAL","ON_TRIAL_DM","CLOSED"]))
                                        ...
                                        @if (globalUserInfo()->role_id == 27)
                                            <input type="hidden" name="userRole" id="getUserRole" value="EM">
                                        @elseif(globalUserInfo()->role_id == 37)
                                            <input type="hidden" name="userRole" id="getUserRole" value="DM">
                                        @endif
                        ...
                        <div class="card card-custom mb-5 shadow">
                            <div class="card-header bg-primary-o-50">
                                ...
                                <div class="card-toolbar">
                                    <a id="addFileRow" href="javascript:;"
                                        class="btn btn-md btn-icon btn-light-light mr-2" title="যুক্ত করুন"
